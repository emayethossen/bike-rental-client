        ...
        <footer className="bg-gray-500 text-white py-8">
            <div className="container mx-auto grid grid-cols-1 md:grid-cols-5 gap-4 px-6 text-center md:text-left">
                ...
                <div>
                    ...
                    <p className="py-1"><FontAwesomeIcon icon={faMapMarkerAlt} className="mr-2" />2443 Oak Ridge Omaha, QA 45065</p>
                    <p className="py-1"><FontAwesomeIcon icon={faPhoneAlt} className="mr-2" />
                        207-8767-452</p>
                    <p className="py-1">
                        <FontAwesomeIcon icon={faEnvelope} className="mr-2" />support@site.com
                    </p>
                </div>
            </div>
