...
import image2 from '../../assets/images/tour2.jpg'
import image3 from '../../assets/images/tour3.jpg'
            ...
            <div className='grid md:grid-cols-2 md:gap-12 gap-4 md:items-center'>
                <div className="text-center md:space-y-12">
                    <h1 className="text-2xl md:text-3xl font-bold md:w-3/5 md:mx-auto mb-4">
                        Auto Bike: The company to offer the best scooter and bike rental services
                    </h1>
                ...
                <div className="md:space-y-12">
                    <div className="hidden gap-4 md:grid md:grid-cols-8">
                        <img src={image2} alt="Scooter and Bike" className="w-full col-span-5 rounded" />
                        <img src={image3} alt="Scooter and Bike" className="w-full h-full col-span-3 rounded" />
                    </div>
                    <div className="md:w-full">
                        <h2 className="text-xl md:text-3xl md:text-left text-center md:text-2xl font-bold mb-4">Renting Service Features</h2>
                        <p className="mb-6 lg:text-left text-center md:w-3/4">Explore top-performing bikes, designed for speed, comfort, and durability. Perfect for all adventure enthusiasts.</p>
